    ...
    <div class="box-header">
        <div class="row">
            ...
            <div class="col-md-2 text-right">
                <a href="{{ url('threads/edit/' . $thread->id) }}" class="btn btn-primary btn-sm margin" role="button">
                    Edit
                </a>
                <a href="{{ url('threads/delete/' . $thread->id) }}" class="btn btn-danger btn-sm margin" role="button">
                    Delete
                </a>
            </div>
        </div>
